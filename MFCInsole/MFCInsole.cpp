...
// MFCInsole.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMFCInsoleApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CMFCInsoleApp

CMFCInsoleApp::CMFCInsoleApp()
{
...
// Единственный объект CMFCInsoleApp

CMFCInsoleApp theApp;


// Инициализация CMFCInsoleApp

BOOL CMFCInsoleApp::InitInstance()
{
